<template>
    ...
    <div class="px-20 my-10 flex justify-between items-center">
       <div>
          ...
          <img class="w-[300px] mt-5" :src="book.image" alt="">
       </div>
       <div class="w-[900px] self-stretch">
          <h1 class="text-5xl font-semibold font-['Playfair_Display'] mb-3">{{book.title}}</h1>
          <p class="font-['Montserrat'] text-3xl font-semibold mb-3">{{book.author}}</p>
          ...
          <p class="text-xl font-medium font-['Montserrat'] mb-3">{{book.description}} </p>
 ...
 <script setup>
    ...
    //  const response = await useFetch(`http://localhost:5000/books/${bookId}`);
